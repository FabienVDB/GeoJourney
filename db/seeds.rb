...
Site.photo.attach(io: file, filename: 'Dinoplagne.jpg', content_type: 'image/jpg')
puts "Western Alps Geotraverse itinerary done"

puts "Create plagne site"
Site.create!(itinerary: geotraverse_western_alps,
             stage: 1,
             name: "Dinoplagne",
...
Site.photo.attach(io: file, filename: 'MontPelerin.jpg', content_type: 'image/jpg')
...
Site.photo.attach(io: file, filename: 'Morcles.jpg', content_type: 'image/jpg')
...
Site.photo.attach(io: file, filename: 'Zermatt.jpg', content_type: 'image/jpg')
